package com.example.omgimbot.mapsbanking.direction.helper;
...
public class Helper {
    ...
    public static final String API_KEY = "AIzaSyABnA0EhjlxZF5C4fMw3obbJZBilbvhF-Q";
    public static final int MY_SOCKET_TIMEOUT_MS = 5000;
    public static String getUrl(String originLat, String originLon, String destinationLat, String destinationLon){
        String url = Helper.DIRECTION_API + originLat+","+originLon+"&destination="+destinationLat+","+destinationLon+"&key="+API_KEY;
        Log.d("URLnya" , url);
